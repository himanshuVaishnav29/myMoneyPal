      ...
      <div className="flex flex-col items-center justify-center px-4 sm:px-6 py-4 sm:py-8 mx-auto min-h-screen lg:py-0 relative z-10">
        ...
        <div className="w-full max-w-sm sm:max-w-md bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl shadow-xl">
          <div className="p-4 sm:p-6 lg:p-8 space-y-3 sm:space-y-4 md:space-y-3">
            <h1 className="text-lg sm:text-xl md:text-2xl font-thin leading-tight tracking-tight text-white mb-4 sm:mb-6 text-center sm:text-left">
            ...
            <form className="space-y-4 md:space-y-3" onSubmit={handleSubmit}>
              ...
              <div>
                <span className="block mb-2 text-sm font-medium text-neutral-200">
                  Gender
                </span>
                <div className="flex items-center space-x-4">
                  <div className="flex items-center">
                    <input
                      ...
                      className="w-4 h-4 bg-transparent text-neutral-200 border-gray-500 focus:ring-indigo-500 accent-indigo-500 hover:cursor-pointer"
                    />
                    <label
                      htmlFor="male"
                      className="ml-2 text-sm font-medium text-neutral-200 hover:cursor-pointer"
                    >
                      Male
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input
                      ...
                      className="w-4 h-4 bg-transparent border-gray-500 focus:ring-indigo-500 accent-indigo-500 hover:cursor-pointer"
                    />
                    <label
                      htmlFor="female"
                      className="ml-2 text-sm font-medium text-neutral-200 hover:cursor-pointer"
            ...
            <form className="space-y-4 md:space-y-3" onSubmit={handleVerifyOTP}>
              ...
              <div>
                <label htmlFor="otp" className="block mb-2 text-xs sm:text-sm font-medium text-neutral-200">
                  Verification Code
                </label>
                <input
                  id="otp"
